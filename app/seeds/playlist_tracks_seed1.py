...
def playlist_tracks_seed1():
  ...
  track2 = PlaylistTrack(order_num=2, track_id=5, playlist_id=1)
  track3 = PlaylistTrack(order_num=3, track_id=2, playlist_id=1)
  track4 = PlaylistTrack(order_num=4, track_id=4, playlist_id=1)
  track5 = PlaylistTrack(order_num=5, track_id=1, playlist_id=1)
  track6 = PlaylistTrack(order_num=6, track_id=6, playlist_id=1)
  track7 = PlaylistTrack(order_num=7, track_id=7, playlist_id=1)
