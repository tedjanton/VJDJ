...
def playlist_tracks_seed2():
  ...
  track2 = PlaylistTrack(order_num=2, track_id=16, playlist_id=2)
  ...
  track11 = PlaylistTrack(order_num=1, track_id=25, playlist_id=4)
  track12 = PlaylistTrack(order_num=2, track_id=22, playlist_id=4)
  track13 = PlaylistTrack(order_num=3, track_id=14, playlist_id=4)
  track14 = PlaylistTrack(order_num=4, track_id=9, playlist_id=4)

  track15 = PlaylistTrack(order_num=1, track_id=22, playlist_id=5)
  track16 = PlaylistTrack(order_num=2, track_id=19, playlist_id=5)
  track17 = PlaylistTrack(order_num=3, track_id=17, playlist_id=5)
  track18 = PlaylistTrack(order_num=4, track_id=23, playlist_id=5)

  track19 = PlaylistTrack(order_num=1, track_id=21, playlist_id=6)
  track20 = PlaylistTrack(order_num=2, track_id=46, playlist_id=6)
  track21 = PlaylistTrack(order_num=3, track_id=20, playlist_id=6)
  track22 = PlaylistTrack(order_num=4, track_id=13, playlist_id=6)
